<template>
  <div class="tables-basic">
    ...
    <h2 class="page-title">Tables -
      <span class="fw-semi-bold">Static</span>
    </h2>
    <b-row>
      <b-col>
        <Widget
            ...
            <table class="table">
              ...
              <tbody>
                <tr v-for="row in tableStyles" :key="row.id">
                  ...
                  <td class="text-semi-muted">{{parseDate(row.date)}}</td>
                  <td class="text-semi-muted">{{row.size}}</td>
                  <td class="width-150">
                    <b-progress
    ...
    <b-row>
      <b-col lg="6">
        ...
        >
          ...
          <p>
            Each row is highlighted. You will never lost
            there. Just
      ...
      <b-col lg="6">
        ...
        >
          ...
          <p>
            ...
            <code>.widget-table-overflow</code> inside
            of widget
          </p>
